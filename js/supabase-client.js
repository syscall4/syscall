...
if (!window.SUPABASE_CONFIG) {
    console.error('❌ Error: No se encontró SUPABASE_CONFIG. Asegúrate de que config.js está cargado antes que este script.')
    throw new Error('Configuración de Supabase no encontrada')
}

// Usar las credenciales del objeto global
